...
namespace form_builder_tests.UnitTests.Providers.Address
{
    public class CRMAddressProviderTests
    {
        ...
        private readonly Mock<ILogger<IAddressProvider>> _mockLogger = new Mock<ILogger<IAddressProvider>>();
        ...
        public CRMAddressProviderTests()
        {
            ...
            _addressProvider = new CRMAddressProvider(_mockVerintGateway.Object, _mockLogger.Object);
        }
