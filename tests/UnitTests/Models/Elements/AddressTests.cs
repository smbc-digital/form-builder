...
namespace form_builder_tests.UnitTests.Models.Elements
{
    public class AddressTests
    {
        ...
        public async Task GenerateHtml_ShouldCallViewRenderWithCorrectPartial_WhenAddressSearch()
        {
            ...
            //Act
            var result = await element.RenderAsync(_mockIViewRender.Object, _mockElementHelper.Object, "", new List<AddressSearchResult>(), new List<StockportGovUK.NetStandard.Models.Models.Verint.Organisation>(), viewModel, page, schema, _mockHostingEnv.Object);
