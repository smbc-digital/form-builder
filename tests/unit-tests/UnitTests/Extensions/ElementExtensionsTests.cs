...
namespace form_builder_tests.UnitTests.Extensions
{
    public class ElementExtensionsTests
    {
        ...
        public void RemoveUnusedConditionalElements_ViewModelShouldContainLessElementsWhenElementsContainMultipleConditionals_ForRadio()
        {
            ...
            var viewModel = new Dictionary<string, dynamic> { { "testQuestion", "Value1" }, { "conditionalQuestion1", "Conditional Answer 1" }, { "conditionalQuestion2", "Conditional Answer 2" } };
        ...
        public void RemoveUnusedConditionalElements_ViewModelShouldContain_SameAmountOf_ElementsWhen_Checkbox_Has_Selected_BothOptions()
        {
            ...
            elements.Add(conditionalElement2);
            elements.Add(element1);
            var viewModel = new Dictionary<string, dynamic> { { "testQuestion", "Value1,Value2" }, { "conditionalQuestion1", "Conditional Answer 1" }, { "conditionalQuestion2", "Conditional Answer 2" } };
        ...
        public void RemoveUnusedConditionalElements_ViewModelShould_Contain_SingleItem_WhenNoOptions_AreTicked_ForCheckbox()
        {
            ...
            elements.Add(conditionalElement2);
            elements.Add(element1);
            var viewModel = new Dictionary<string, dynamic> { { "testQuestion", "" }, { "conditionalQuestion1", "Conditional Answer 1" }, { "conditionalQuestion2", "Conditional Answer 2" } };
        ...
        [Fact]
        public void RemoveUnusedConditionalElements_ElementListShould_Contain_OnlyConditionalElementsThatHaveCorrespondingOptions()
        {
            List<IElement> elements = new List<IElement>();
            var conditionalElement1 = new ElementBuilder()
                .WithType(EElementType.Textbox)
