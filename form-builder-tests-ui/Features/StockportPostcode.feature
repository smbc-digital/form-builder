...
Scenario: Postcode validation standard use
	...
	#And I should see a ".govuk-error-message" element with "Check the stockport postcode and try again" text
	Then I fill in page1 with wrong postcode
	Then I click the "nextStep" button
	#And I should see a "span" element with "" text
	#And I should see a ".govuk-error-message" element with "Stockport postcode must be a valid postcode" text
	Then I fill in page1 with wrong postcode
