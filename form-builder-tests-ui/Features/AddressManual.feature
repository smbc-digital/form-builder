...
Scenario: Address Manual element standard use
	...
	#Then I should see a "span" element with "Please enter Address Line 1" text
	#And I should see a "span" element with "Please enter Town" text
	#And I should see a "span" element with "Please enter a Postcode" text
	#Then I fill in address line one
	#And I fill in town
	#When I click the "nextStep" button
	#Then I should see a "span" element with "Please enter a Postcode" text
	#Then I fill in invalid postcode
	#When I click the "nextStep" button
	#Then I wait one second
	#Then I should see a "span" element with "Please enter a valid Postcode" text
	...
	#Then I should see a "th" element with "customersaddress-AddressLine1" text
	#And I should see a "th" element with "customersaddress-AddressTown" text
	#And I should see a "th" element with "customersaddress-ManualPostcode" text
