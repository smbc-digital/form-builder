        ...
        public IntegrityCheckResult Validate(FormSchema schema)
        {
            ...
            if (bookingElements.Any())
            {
                bookingElements.ForEach((booking) =>
                {
                    ...
                    {
                        integrityCheckResult.AddFailureMessage($"Booking Element Check, No appointment type found for current environment or empty AppointmentID on form {schema.FormName}.");
                    }
