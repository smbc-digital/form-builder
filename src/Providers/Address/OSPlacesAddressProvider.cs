...
public class OSPlacesAddressProvider(
    IGateway gateway,
    IOptions<OSPlacesAddressProviderConfiguration> oSPlacesAddressProviderConfiguration,
    ILogger<OSPlacesAddressProvider> logger)
    : IAddressProvider
{
    private readonly ILogger<OSPlacesAddressProvider> _logger = logger;
    public string ProviderName => "OSPlaces";

    private readonly IGateway _gateway = gateway;
    private readonly OSPlacesAddressProviderConfiguration _oSPlacesAddressProviderConfiguration = oSPlacesAddressProviderConfiguration.Value;
