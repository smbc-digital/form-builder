...
public class ActionsWorkflow(
    IRetrieveExternalDataService retrieveExternalDataService,
    ...
    : IActionsWorkflow
{
    private readonly IRetrieveExternalDataService _retrieveExternalDataService = retrieveExternalDataService;
    private readonly IEmailService _emailService = emailService;
    private readonly ISchemaFactory _schemaFactory = schemaFactory;
    private readonly IValidateService _validateService = validateService;
    private readonly ITemplatedEmailService _templatedEmailService = templatedEmailService;
