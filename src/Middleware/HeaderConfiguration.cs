namespace form_builder.Middleware
{
    public class HeaderConfiguration
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            {
                headers["Content-Security-Policy"] = $"frame-ancestors 'self' http://www.stockport.gov.uk https://www.stockport.gov.uk https://int-webplatform-stockportgov.smbcdigital.net/ https://int-webplatform-stockroom.smbcdigital.net/ https://qa-webplatform-stockportgov.smbcdigital.net/ https://stage-webplatform-stockportgov.smbcdigital.net/ {testUrls}";
                headers["X-Content-Security-Policy"] = $"frame-ancestors 'self' http://www.stockport.gov.uk https://www.stockport.gov.uk https://int-webplatform-stockportgov.smbcdigital.net https://int-webplatform-stockroom.smbcdigital.net/ https://qa-webplatform-stockportgov.smbcdigital.net/ https://stage-webplatform-stockportgov.smbcdigital.net/ {testUrls}";
            }

            headers["Access-Control-Allow-Origin"] = $"http://www.stockport.gov.uk https://www.stockport.gov.uk https://int-webplatform-stockportgov.smbcdigital.net https://int-webplatform-stockroom.smbcdigital.net/ https://qa-webplatform-stockportgov.smbcdigital.net/ https://stage-webplatform-stockportgov.smbcdigital.net/ {testUrls}";
